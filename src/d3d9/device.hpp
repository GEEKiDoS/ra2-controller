...
{
public:
	d3d9_device_proxy(IDirect3DDevice9* orig, D3DPRESENT_PARAMETERS* pp, HWND window);

private:
	IDirect3DDevice9* m_device;
	HWND m_hwnd;
	D3DPRESENT_PARAMETERS m_pp;
	std::function<void(d3d9_device_proxy*)> m_present_cb;
public:
	...
	static void on_create(std::function<void(d3d9_device_proxy*)> callback);
	void on_present(std::function<void(d3d9_device_proxy*)> callback);
	HWND get_hwnd() const;
	static d3d9_device_proxy* instance();

private:
	static d3d9_device_proxy* _instance;
};
